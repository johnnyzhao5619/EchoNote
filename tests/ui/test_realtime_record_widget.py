...
from ui.realtime_record.widget import RealtimeRecordWidget, RealtimeRecorderSignals
...
class TestRealtimeRecordWidget:
    ...
    @pytest.fixture
    def widget(self, qapp, mock_realtime_recorder, mock_audio_capture, mock_i18n, mock_settings_manager):
