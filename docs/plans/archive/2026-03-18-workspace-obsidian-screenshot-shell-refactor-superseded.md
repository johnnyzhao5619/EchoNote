...
**Scope Note:** 本计划是 `archive/2026-03-15-workspace-redbox-closure-plan-superseded.md` 之后的截图壳层跟进，只覆盖 structure/event 暴露、stacked-tabs menu、SVG icon 统一与 editor chrome 层级收紧，不重复定义 red-box 计划里其他布局项。
...
- Modify: `/Users/weijiazhao/Dev/EchoNote/docs/plans/archive/2026-03-18-workspace-obsidian-screenshot-shell-refactor-superseded.md`
...
def test_workspace_docs_point_to_current_screenshot_shell_plan():
    ...
    assert "2026-03-18-workspace-obsidian-screenshot-shell-refactor-superseded.md" in readme
```
...
- Historical plan: plans/archive/2026-03-18-workspace-obsidian-screenshot-shell-refactor-superseded.md
```
...
```bash
git add /Users/weijiazhao/Dev/EchoNote/docs/README.md /Users/weijiazhao/Dev/EchoNote/docs/plans/archive/2026-03-18-workspace-obsidian-screenshot-shell-refactor-superseded.md
