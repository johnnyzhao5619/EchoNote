...
from PyQt6.QtWidgets import (
    QLabel, QComboBox, QHBoxLayout, QFrame, QVBoxLayout
)
...
class AppearanceSettingsPage(BaseSettingsPage):
    ...
    def setup_ui(self):
        ...
        self.preview_text = QLabel(
            self.i18n.t('settings.appearance.preview_text')
        )
        ...
        self.info_label = QLabel(
            self.i18n.t('settings.appearance.theme_info')
        )
    ...
    def update_translations(self):
        ...
        if hasattr(self, 'theme_label'):
            self.theme_label.setText(
                self.i18n.t('settings.appearance.theme_select')
            )
        if hasattr(self, 'preview_label'):
            self.preview_label.setText(
                self.i18n.t('settings.appearance.preview')
            )
