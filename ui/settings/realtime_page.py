...
class RealtimeSettingsPage(BaseSettingsPage):
    ...
    def setup_ui(self):
        ...
        self.source_label = QLabel(
            self.i18n.t('settings.realtime.input_source')
        )
        ...
        self.format_label = QLabel(
            self.i18n.t('settings.realtime.recording_format')
        )
        ...
        self.translation_label = QLabel(
            self.i18n.t('settings.realtime.translation_engine')
        )
    ...
    def _on_browse_clicked(self):
        ...
        directory = QFileDialog.getExistingDirectory(
            self,
            self.i18n.t('settings.realtime.select_directory'),
            current_path
        )
    ...
    def load_settings(self):
        ...
        try:
            # Input source
            input_source = self.settings_manager.get_setting(
                'realtime.default_input_source'
            )
            if input_source:
            ...
            # Recording format
            recording_format = self.settings_manager.get_setting(
            ...
            auto_save = self.settings_manager.get_setting(
                'realtime.auto_save'
            )
    ...
    def validate_settings(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            return False, self.i18n.t(
                'settings.realtime.error.invalid_path',
                error=str(e)
            )
    ...
    def update_translations(self):
        ...
        if hasattr(self, 'gain_label'):
            self.gain_label.setText(
                self.i18n.t('settings.realtime.gain_level')
            )
