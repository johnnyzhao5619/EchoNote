...
class LanguageSettingsPage(BaseSettingsPage):
    ...
    def update_translations(self):
        ...
        if hasattr(self, "language_title"):
            self.language_title.setText(self.i18n.t("settings.language.title"))

        # Update labels
        if hasattr(self, "language_label"):
            self.language_label.setText(self.i18n.t("settings.language.select"))
        if hasattr(self, "info_label"):
            self.info_label.setText(self.i18n.t("settings.language.change_info"))
