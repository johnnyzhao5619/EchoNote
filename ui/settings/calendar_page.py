...
class CalendarSettingsPage(BaseSettingsPage):
    ...
    def setup_ui(self):
        ...
        self.desc_label = QLabel(
            self.i18n.t('settings.calendar.accounts_description')
        )
        ...
        self.add_google_button = QPushButton(
            self.i18n.t('settings.calendar.add_google')
        )
        self.add_google_button.clicked.connect(self._on_add_google_clicked)
        buttons_layout.addWidget(self.add_google_button)
        
        self.add_outlook_button = QPushButton(
            self.i18n.t('settings.calendar.add_outlook')
        )
        ...
        self.remove_button = QPushButton(
            self.i18n.t('settings.calendar.remove_account')
        )
        ...
        self.sync_info = QLabel(
            self.i18n.t('settings.calendar.sync_info')
        )
    ...
    def update_translations(self):
        ...
        if hasattr(self, 'accounts_title'):
            self.accounts_title.setText(
                self.i18n.t('settings.calendar.connected_accounts')
            )
        if hasattr(self, 'sync_title'):
            self.sync_title.setText(
                self.i18n.t('settings.calendar.sync_settings')
            )
        ...
        if hasattr(self, 'add_google_button'):
            self.add_google_button.setText(
                self.i18n.t('settings.calendar.add_google')
            )
        if hasattr(self, 'add_outlook_button'):
            self.add_outlook_button.setText(
                self.i18n.t('settings.calendar.add_outlook')
            )
