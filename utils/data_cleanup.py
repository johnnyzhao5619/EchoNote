...
class DataCleanup:
    ...
    def cleanup_all_data(self) -> dict:
        ...
        results = {"success": True, "deleted_items": [], "failed_items": [], "errors": []}
        ...
        if results["success"]:
            ...
            logger.warning(f"Cleanup completed with {len(results['failed_items'])} errors")
        ...
        if self.config_dir.exists():
            try:
                ...
                try:
                    ...
                    logger.warning(
                        f"Config directory not empty, could not delete: " f"{self.config_dir}"
                    )
